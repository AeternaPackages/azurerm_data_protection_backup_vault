...
module "data_protection_backup_vaults" {
  source                        = "git::https://github.com/AeternaModules/azurerm_data_protection_backup_vault.git?ref=v4.81.0"
...
module "data_protection_backup_instance_data_lake_storages" {
  source                                             = "git::https://github.com/AeternaModules/azurerm_data_protection_backup_instance_data_lake_storage.git?ref=v4.81.0"
...
module "data_protection_backup_policy_data_lake_storages" {
  source                                           = "git::https://github.com/AeternaModules/azurerm_data_protection_backup_policy_data_lake_storage.git?ref=v4.81.0"
...
module "data_protection_backup_vault_customer_managed_keys" {
  source                                             = "git::https://github.com/AeternaModules/azurerm_data_protection_backup_vault_customer_managed_key.git?ref=v4.81.0"
